...
public class RideAlreadyFinishedValidatorTest {

    @InjectMocks
    private RideAlreadyFinishedValidator subject;
    ...
    @Test
    public void shouldDoNothingWhenValidateWithRideWithStatusIniciada() {
        ride.setStatus(RideStatus.INICIADA);
        subject.validate(ride);
    }

    @Test(expected = BusynessLogicException.class)
    public void shouldThrowWhenValidateWithRideWithStatusDifferentFromIniciada() {
