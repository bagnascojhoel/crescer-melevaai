...
public class RideNotFinishedYetValidatorTest {

    @InjectMocks
    private RideNotFinishedYetValidator subject;
    ...
    @Test
    public void shouldDoNothingWhenValidateWithRideWithStatusEqualFinalizada() {
        ride.setStatus(RideStatus.FINALIZADA);
        subject.validate(ride);
    }

    @Test(expected = BusynessLogicException.class)
    public void shouldThrowWhenValidateWithRideWithStatusDifferentFromFinalizada() {
